...
export type FdUpdateProfileRequest = z.infer<typeof UpdateProfileSchema>;
...
export type FdChangePasswordRequest = z.infer<typeof ChangePasswordSchema>;

// ── Responses ─────────────────────────────────────────────────────────────────

export interface FdProfileResponse {
  userId: string;
  ...
  role: string;
  assignedProperties: { id: string; name: string | null }[];
}
