...
import { FdWalkInsService } from "../../services/front-desk/fdWalkInsService";
import {
...
@Route("front-desk/walk-ins")
@Tags("Front Desk - Walk-In Visitors")
@Security("jwt", ["FRONT_DESK"])
export class FdWalkInsController extends Controller {
  private service = new FdWalkInsService();
  ...
  /**
   * Returns all walk-in visits across the front desk's managed properties.
