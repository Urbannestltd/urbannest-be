...
export class FdGateService {
  ...
  public async checkIn(fdId: string, inviteId: string): Promise<void> {
    const invite = await this.assertFdManagesInvite(fdId, inviteId);
  ...
  public async checkOut(fdId: string, inviteId: string): Promise<void> {
    const invite = await this.assertFdManagesInvite(fdId, inviteId);
  ...
  public async requestDeparture(fdId: string, inviteId: string): Promise<void> {
    const invite = await this.assertFdManagesInvite(fdId, inviteId);
